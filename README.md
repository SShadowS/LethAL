...
[![Release](https://img.shields.io/badge/release-0.1.0--alpha.3-orange)](CHANGELOG.md)
...
```bash
./build/lethal-0.1.0-alpha.3-windows-x64.exe --version
```
...
| `lethal.toggle-blank-temporal` | 1.0.0 | `0D` → `17530101D` | a date-is-set check nobody drives with the other setting |
...
| `LETHAL_ITEST_ALRUNNER=1 bun run itest:alrunner` | The al-runner backend | 3 / 12 / 4 |
