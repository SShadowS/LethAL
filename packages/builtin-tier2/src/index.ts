 ...
 *
 * Two of the four Phase-1 Tier-2 operators (docs/superpowers/plans/2026-07-26-tier2-phase1.md,
 * Tasks 3-4) are registered so far: `RemoveTestField` and `RemoveSetRange`. `RemoveCalcFields` and
 ...
 */
export const tier2Operators: readonly MutationOperator[] = [removeTestField, removeSetRange];
